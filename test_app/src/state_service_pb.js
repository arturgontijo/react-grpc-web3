 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.escrow.ChannelStateRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getChannelId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      1,
      f
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.escrow.ChannelStateReply.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getCurrentNonce_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      1,
      f
  ...
  f = this.getCurrentSignedAmount_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      2,
      f
  ...
  f = this.getCurrentSignature_asU8();
  if (f.length > 0) {
    writer.writeBytes(
      3,
      f
